        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-slate-400">
                    <?php echo e($jadwal->kelas); ?> &middot; <?php echo e($jadwal->jam_formatted); ?> &middot; <?php echo e($jadwal->ruang); ?> &middot; Dosen: <?php echo e($jadwal->dosen->nama ?? '-'); ?>
                    ...
                    <tbody class="divide-y divide-gray-50 dark:divide-white/5">
                        <?php $__currentLoopData = $absensis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $absen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                                ...
                                <td class="px-5 py-3 text-sm text-gray-800 dark:text-white"><?php echo e($absen->mahasiswa->nama ?? '-'); ?></td>
                                ...
                                <td class="px-5 py-3">
                                    <?php if($absen->status === 'Menunggu'): ?>
                                        <div class="flex gap-1.5">
                                            <form action="<?php echo e(route('admin.presensi.updateStatus', $absen->id_absensi)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                    ...
                                    <?php else: ?>
                                        <form action="<?php echo e(route('admin.presensi.updateStatus', $absen->id_absensi)); ?>" method="POST" class="flex gap-2">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <select name="status" class="text-xs border rounded-lg px-2 py-1 dark:bg-white/5 dark:border-white/10 dark:text-white">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ghifa's court\web-presensi-feb\resources\views\admin\dosen\validasi.blade.php ENDPATH**/ ?>