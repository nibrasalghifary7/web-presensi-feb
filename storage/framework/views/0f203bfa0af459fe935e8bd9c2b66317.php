...
<head>
    ...
    <style>
        ...
        .sidebar-tooltip-float.show {
            opacity: 1;
        }
        html.dark .sidebar-tooltip-float {
            background: #1e293b;
            border: 1px solid rgba(255,255,255,0.1);
            box-shadow: 0 4px 16px rgba(0,0,0,0.4);
        }
        @media (max-width: 1023px) {
            .sidebar-tooltip-float { display: none !important; }
        }
    </style>
...
<body class="h-full font-sans antialiased bg-gray-50 dark:bg-aurora-bg text-gray-800 dark:text-white">
    ...
    <div class="h-screen flex relative z-10"
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="flex items-center gap-2.5 px-4 py-4 border-b border-gray-100 dark:border-white/5"
                ...
                <div class="w-14 h-12 rounded-lg flex items-center justify-center flex-shrink-0">
                    <img src="<?php echo e(asset('005d5b9dc825d74b4f47a1a022a7913f-removebg-preview-1@2x.png')); ?>" alt="Logo">
                </div>
                ...
                <?php $__currentLoopData = $menuItems ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a href="<?php echo e(route($item['route'])); ?>"
                       ...
                       :class="sidebarCollapsed ? 'lg:justify-center lg:px-0' : ''">
                        ...
                        <?php endif; ?>
                        <span class="sidebar-tooltip-text hidden"><?php echo e(__($item['label'])); ?></span>
                    </a>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            tip.className = 'sidebar-tooltip-float';
            ...
            document.querySelectorAll('.sidebar-link').forEach(function(link) {
                link.addEventListener('mouseenter', function() {
                    ...
                    var label = this.querySelector('.sidebar-tooltip-text');
                    if (!label) return;
...
<?php /**PATH C:\laragon\www\web-presensi-feb\resources\views/layouts/app.blade.php ENDPATH**/ ?>