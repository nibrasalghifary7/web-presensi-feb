...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm dark:shadow-slate-900/50 border border-gray-100 dark:border-slate-700">
        <form method="GET" class="flex flex-col sm:flex-row gap-3">
            <select name="hari" class="px-4 py-2 rounded-lg border border-gray-200 dark:border-slate-600 text-sm">
            ...
            <select name="kelas" class="flex-1 px-4 py-2 rounded-lg border border-gray-200 dark:border-slate-600 text-sm focus:border-uin-green dark:bg-slate-700 dark:text-white outline-none">
            ...
            <button type="submit" class="px-4 py-2 bg-gray-100 text-gray-700 dark:text-slate-200 rounded-lg text-sm hover:bg-gray-200">
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php $__empty_1 = true; $__currentLoopData = $jadwals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 dark:bg-slate-700">
            ...
            <form method="POST" action="<?php echo e(route('admin.jadwal.store')); ?>" class="space-y-4">
                ...
                <div class="flex gap-3 pt-2">
                    ...
                    <button type="button" onclick="document.getElementById('modalJadwal').classList.add('hidden')"
                            class="flex-1 px-4 py-2.5 bg-gray-100 text-gray-700 dark:text-slate-200 rounded-xl font-medium hover:bg-gray-200">Batal</button>
                </div>
            </form>
        </div>
    </div>
