...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h3 class="text-lg font-bold text-gray-800"><?php echo e(__('app.admin.mahasiswa_list')); ?></h3>
            <p class="text-sm text-gray-500"><?php echo e(__('app.admin.mahasiswa_subtitle')); ?></p>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ghifa's court\web-presensi-feb\resources\views/admin/mahasiswa/index.blade.php ENDPATH**/ ?>