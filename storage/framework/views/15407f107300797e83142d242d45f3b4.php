                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2 mt-1">
                                        <span class="px-2 py-0.5 rounded-full text-xs font-semibold
                                            <?php echo e($izin->jenis == 'Sakit' ? 'bg-red-100 text-red-700' : 'bg-amber-100 text-amber-700'); ?>">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1"><?php echo e($izin->alasan); ?></p>
                                </div>
                                <span class="px-2.5 py-0.5 rounded-full text-xs font-semibold
                                    <?php echo e($izin->status == 'disetujui' ? 'bg-emerald-100 text-emerald-700' : ($izin->status == 'ditolak' ? 'bg-red-100 text-red-700' : 'bg-gray-100 text-gray-600')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-presensi-feb\resources\views/mahasiswa/dokumen.blade.php ENDPATH**/ ?>