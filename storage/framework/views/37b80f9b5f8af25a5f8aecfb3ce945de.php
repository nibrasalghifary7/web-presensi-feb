...
<div class="space-y-6">
    ...
    <div>
        <h3 class="text-lg font-bold text-gray-800">Data Absensi</h3>
        <p class="text-sm text-gray-500">Pantau dan koreksi data kehadiran mahasiswa</p>
    </div>
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php $__empty_1 = true; $__currentLoopData = $absensis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-5 py-3 text-sm text-gray-600"><?php echo e($a->jam_masuk ? substr($a->jam_masuk, 0, 5) : '-'); ?></td>
                            <td class="px-5 py-3">
    ...
    <div id="modalEdit" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl">
            <h3 class="text-lg font-bold text-gray-800 mb-4">Koreksi Absensi</h3>
            <form id="formEdit" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="edit_catatan" name="catatan" rows="3"
                              ...
                              class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:border-uin-green outline-none resize-none"></textarea>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-presensi-feb\resources\views\admin\absensi\index.blade.php ENDPATH**/ ?>