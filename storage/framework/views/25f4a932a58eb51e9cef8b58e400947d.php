...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm dark:shadow-slate-900/50 border border-gray-100 dark:border-slate-700">
        <form method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('admin.laporan.index')); ?>" class="px-4 py-2 bg-gray-50 dark:bg-slate-700 text-gray-500 dark:text-slate-400 rounded-lg text-sm hover:bg-gray-100 dark:hover:bg-slate-600">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-4">
        <div class="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm dark:shadow-slate-900/50 border border-gray-100 dark:border-slate-700 text-center">
            <p class="text-2xl font-bold text-gray-800 dark:text-white"><?php echo e($totalSemua); ?></p>
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php $__empty_1 = true; $__currentLoopData = $absensis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-slate-700">
                            ...
                            <td class="px-5 py-3 text-sm text-gray-600 dark:text-slate-300"><?php echo e($a->jadwal->dosen->nama ?? '-'); ?></td>
