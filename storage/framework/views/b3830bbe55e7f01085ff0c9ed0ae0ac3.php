...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm dark:shadow-slate-900/50 border border-gray-100 dark:border-slate-700 overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php $__empty_1 = true; $__currentLoopData = $mataKuliahs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/50">
                            <td class="px-5 py-3 text-sm font-medium text-gray-800 dark:text-white"><?php echo e($mk->kode_mk); ?></td>
                            <td class="px-5 py-3 text-sm text-gray-800 dark:text-white"><?php echo e($mk->nama_mk); ?></td>
                            <td class="px-5 py-3 text-sm text-center text-gray-600 dark:text-slate-300"><?php echo e($mk->sks); ?></td>
                            <td class="px-5 py-3 text-sm text-gray-600 dark:text-slate-300"><?php echo e($mk->semester); ?></td>
                            <td class="px-5 py-3">
        ...
        <div class="px-5 py-3 border-t border-gray-100 dark:border-slate-700"><?php echo e($mataKuliahs->links()); ?></div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ghifa's court\web-presensi-feb\resources\views/admin/mata-kuliah/index.blade.php ENDPATH**/ ?>