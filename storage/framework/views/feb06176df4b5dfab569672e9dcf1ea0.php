...
<div class="card-wrapper">
  ...
  <div class="register-panel">
    ...
    <div class="role-selector" id="roleSelector">
      ...
      <label for="roleDsn" id="labelDsn" onclick="slideTo('right', '<?php echo e(route('register-dosen')); ?>')">DOSEN BARU</label>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('register.post')); ?>" style="display:flex;flex-direction:column;flex:1;">
      <?php echo csrf_field(); ?>
      ...
      <div class="form-row">
        <div class="form-col">
          ...
          <div class="input-group">
            <input type="text" name="nim" class="form-input" placeholder="Contoh: 1220905" value="<?php echo e(old('nim')); ?>" required>
          </div>
        </div>
        <div class="form-col">
          <label class="field-label">Nomor Telepon</label>
          <div class="input-group">
            <input type="text" name="phone" class="form-input" placeholder="Contoh: 08123456789" value="<?php echo e(old('phone')); ?>" required>
          </div>
        </div>
      </div>
...
<?php /**PATH C:\laragon\www\web-presensi-feb\resources\views/auth/register-mahasiswa.blade.php ENDPATH**/ ?>