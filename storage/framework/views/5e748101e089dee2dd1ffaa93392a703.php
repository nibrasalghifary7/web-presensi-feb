...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100 glass stat-glow-blue">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-blue-600 dark:text-blue-400"><?php echo e($totalPertemuan); ?></p>
                    <p class="text-xs text-gray-500 dark:text-slate-400"><?php echo e(__('app.mahasiswa.total_pertemuan')); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100 glass stat-glow-emerald">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-slate-400"><?php echo e(__('app.mahasiswa.hadir')); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100 glass stat-glow-amber">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-slate-400"><?php echo e(__('app.mahasiswa.izin_sakit')); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100 glass stat-glow-red">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-slate-400"><?php echo e(__('app.mahasiswa.alpha')); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 glass">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h3 class="text-lg font-bold text-gray-800 dark:text-white"><?php echo e(__('app.mahasiswa.persentase')); ?></h3>
                <p class="text-sm text-gray-500 dark:text-slate-400 mt-1"><?php echo e(__('app.mahasiswa.persentase_desc')); ?></p>
            </div>
            <div class="flex items-center gap-4">
                <div class="relative w-20 h-20">
                    <svg class="w-20 h-20 transform -rotate-90" viewBox="0 0 36 36">
                        ...
                        <path d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="<?php echo e($persentase>=75?'#10b981':($persentase>=50?'#f59e0b':'#ef4444')); ?>" stroke-width="3" stroke-dasharray="<?php echo e($persentase); ?>, 100"/>
                    </svg>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <span class="text-base font-bold text-gray-800 dark:text-white"><?php echo e($persentase); ?>%</span>
                    </div>
                </div>
                <div>
    ...
    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 glass">
        <h3 class="text-lg font-bold text-gray-800 dark:text-white mb-4">
            <i class="fas fa-calendar-day text-primary dark:text-aurora-glow mr-2"></i><?php echo e(__('app.mahasiswa.jadwal_hari_ini')); ?>
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100 dark:bg-white/5 dark:border-white/5">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-400 dark:text-slate-500"><?php echo e($jadwal->dosen->nama); ?></p>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ghifa's court\web-presensi-feb\resources\views/mahasiswa/dashboard.blade.php ENDPATH**/ ?>