...
<head>
  ...
  <title>Registrasi Dosen - M-PRESENCE FEB</title>
...
<div class="card-wrapper">
  ...
  <div class="register-panel">
    <div class="panel-header">
      <img alt="" src="<?php echo e(asset('person.svg')); ?>">
      <span class="panel-title">REGISTRASI MANDIRI FEB</span>
    </div>

    <div class="divider-line"></div>

    <!-- role selector with sliding pill (dosen active = slider right) -->
    <label class="field-label">MENDAFTAR SEBAGAI</label>
    <div class="role-selector" id="roleSelector">
      <div class="role-slider" id="roleSlider"></div>
      <input type="radio" name="role_page" id="roleMhs" value="mahasiswa">
      <label for="roleMhs" id="labelMhs" onclick="slideTo('left', '<?php echo e(route('register-mahasiswa')); ?>')">MAHASISWA BARU</label>
      <input type="radio" name="role_page" id="roleDsn" value="dosen" checked>
      <label for="roleDsn" id="labelDsn" class="active">DOSEN BARU</label>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('register-dosen.post')); ?>" style="display:flex;flex-direction:column;flex:1;">
      <?php echo csrf_field(); ?>

      <label class="field-label">NAMA LENGKAP</label>
      <div class="input-group">
        <input type="text" name="nama" class="form-input" placeholder="Nama Lengkap Anda..." value="<?php echo e(old('nama')); ?>" required>
      </div>

      <label class="field-label">NIP (NOMOR INDUK PEGAWAI)</label>
      <div class="input-group">
        <input type="text" name="nidn" class="form-input" placeholder="Contoh: 19920808" value="<?php echo e(old('nidn')); ?>" required>
      </div>

      <label class="field-label">ALAMAT EMAIL</label>
      <div class="input-group">
        <input type="email" name="email" class="form-input" placeholder="Email Akademik..." value="<?php echo e(old('email')); ?>" required>
      </div>
        ...
        <div class="form-col">
          ...
          <div class="input-group select-wrapper" style="margin-bottom:0;">
            <select name="jenis_kelamin" class="form-select">
              <option value="L" <?php echo e(old('jenis_kelamin', 'L') == 'L' ? 'selected' : ''); ?>>Laki-Laki</option>
        ...
        <div class="form-col">
          ...
          <div class="input-group" style="margin-bottom:0;">
            <div class="password-wrapper">
              <input type="password" name="pin" id="pin" class="form-input" placeholder="123456" maxlength="6" inputmode="numeric" pattern="[0-9]*" value="<?php echo e(old('pin')); ?>" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
...
<?php /**PATH D:\ghifa's court\web-presensi-feb\resources\views/auth/register-dosen.blade.php ENDPATH**/ ?>