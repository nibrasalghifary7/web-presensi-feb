...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm dark:shadow-slate-900/50 border border-gray-100 dark:border-slate-700 overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php $__empty_1 = true; $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-slate-700">
                            <td class="px-5 py-3 text-sm text-gray-500 dark:text-slate-400"><?php echo e($kelas->firstItem() + $index); ?></td>
                            <td class="px-5 py-3 text-sm font-medium text-gray-800 dark:text-white"><?php echo e($k->nama_kelas); ?></td>
                            <td class="px-5 py-3 text-sm text-gray-600 dark:text-slate-300"><?php echo e($k->angkatan); ?></td>
                            <td class="px-5 py-3 text-sm text-gray-600 dark:text-slate-300"><?php echo e($k->prodi); ?></td>
                            <td class="px-5 py-3 text-sm text-center text-gray-600 dark:text-slate-300"><?php echo e($k->mahasiswas_count); ?></td>
                            <td class="px-5 py-3">
        ...
        <div class="px-5 py-3 border-t border-gray-100 dark:border-slate-700"><?php echo e($kelas->withQueryString()->links()); ?></div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ghifa's court\web-presensi-feb\resources\views\admin\kelas\index.blade.php ENDPATH**/ ?>