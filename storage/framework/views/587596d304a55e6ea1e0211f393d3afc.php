...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h3 class="text-lg font-bold text-gray-800 dark:text-white">Jadwal Kuliah</h3>
            <p class="text-sm text-gray-500 dark:text-slate-400">Kelola jadwal perkuliahan</p>
        </div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm dark:shadow-slate-900/50 border border-gray-100 dark:border-slate-700">
        <form method="GET" class="flex flex-col sm:flex-row gap-3">
            <select name="hari" class="px-4 py-2 rounded-lg border border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-white text-sm outline-none">
            ...
            <select name="kelas" class="flex-1 px-4 py-2 rounded-lg border border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-white text-sm focus:border-uin-green outline-none">
            ...
            <table class="w-full">
                <thead class="bg-gray-50 dark:bg-slate-700">
                    <tr>
                        ...
                        <th class="px-5 py-3 text-left text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase">Ruang</th>
                ...
                <tbody class="divide-y divide-gray-50 dark:divide-slate-700">
                    <?php $__empty_1 = true; $__currentLoopData = $jadwals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-slate-700">
                            <td class="px-5 py-3 text-sm font-medium text-gray-800 dark:text-white"><?php echo e($j->mataKuliah->nama_mk); ?></td>
                            <td class="px-5 py-3 text-sm text-gray-600 dark:text-slate-300"><?php echo e($j->dosen->nama); ?></td>
                            <td class="px-5 py-3 text-sm text-gray-600 dark:text-slate-300"><?php echo e($j->hari); ?></td>
                            <td class="px-5 py-3 text-sm text-gray-600 dark:text-slate-300"><?php echo e($j->jam_formatted); ?></td>
                            <td class="px-5 py-3 text-sm text-gray-600 dark:text-slate-300"><?php echo e($j->ruang); ?></td>
                            <td class="px-5 py-3 text-sm text-gray-600 dark:text-slate-300"><?php echo e($j->kelas); ?></td>
                            <td class="px-5 py-3">
                                <div class="flex gap-2">
                                    ...
                                    <form action="<?php echo e(route('admin.jadwal.destroy', $j->id_jadwal)); ?>" method="POST"
                                        ...
                                        <button type="submit" class="px-3 py-1 bg-red-100 text-red-700 dark:bg-red-500/10 dark:text-red-400 dark:hover:bg-red-500/20 rounded-lg text-xs font-medium hover:bg-red-200">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr><td colspan="7" class="px-5 py-12 text-center text-gray-400 dark:text-slate-500">Belum ada jadwal</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
        <div class="px-5 py-3 border-t border-gray-100 dark:border-slate-700"><?php echo e($jadwals->withQueryString()->links()); ?></div>
    </div>
    ...
    <div id="modalJadwal" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 w-full max-w-lg shadow-2xl">
            <h3 class="text-lg font-bold text-gray-800 dark:text-white mb-4">Tambah Jadwal Kuliah</h3>
            <form method="POST" action="<?php echo e(route('admin.jadwal.store')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-slate-200 mb-1">Mata Kuliah</label>
                        <select name="id_mk" required class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 text-sm focus:border-uin-green dark:bg-slate-700 dark:text-white outline-none">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-slate-200 mb-1">Dosen</label>
                        <select name="nidn" required class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 text-sm focus:border-uin-green dark:bg-slate-700 dark:text-white outline-none">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-slate-200 mb-1">Hari</label>
                        <select name="hari" required class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 text-sm focus:border-uin-green dark:bg-slate-700 dark:text-white outline-none">
                            <?php $__currentLoopData = ['Senin','Selasa','Rabu','Kamis','Jumat','Sabtu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hari): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div>
                        ...
                        <select name="kelas" required class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 text-sm focus:border-uin-green dark:bg-slate-700 dark:text-white outline-none">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-slate-200 mb-1">Jam Mulai</label>
                        <input type="time" name="jam_mulai" required class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 text-sm focus:border-uin-green dark:bg-slate-700 dark:text-white outline-none">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-slate-200 mb-1">Jam Selesai</label>
                        <input type="time" name="jam_selesai" required class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 text-sm focus:border-uin-green dark:bg-slate-700 dark:text-white outline-none">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-slate-200 mb-1">Ruang</label>
                ...
                <div class="flex gap-3 pt-2">
                    ...
                    <button type="button" onclick="document.getElementById('modalJadwal').classList.add('hidden')"
                            class="flex-1 px-4 py-2.5 bg-gray-100 text-gray-700 dark:bg-slate-700 dark:text-slate-200 rounded-xl font-medium hover:bg-gray-200 dark:hover:bg-slate-600">Batal</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="modalEditJadwal" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 w-full max-w-lg shadow-2xl">
            <h3 class="text-lg font-bold text-gray-800 dark:text-white mb-4">Edit Jadwal Kuliah</h3>
            <form id="formEditJadwal" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-slate-200 mb-1">Mata Kuliah</label>
                        <select name="id_mk" id="edit_mk" required class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 text-sm focus:border-uin-green dark:bg-slate-700 dark:text-white outline-none">
                            <?php $__currentLoopData = $mataKuliahs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($mk->id_mk); ?>"><?php echo e($mk->nama_mk); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-slate-200 mb-1">Dosen</label>
                        <select name="nidn" id="edit_nidn" required class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 text-sm focus:border-uin-green dark:bg-slate-700 dark:text-white outline-none">
                            <?php $__currentLoopData = $dosens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($d->nidn); ?>"><?php echo e($d->nama); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-slate-200 mb-1">Hari</label>
                        <select name="hari" id="edit_hari" required class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 text-sm focus:border-uin-green dark:bg-slate-700 dark:text-white outline-none">
                            <?php $__currentLoopData = ['Senin','Selasa','Rabu','Kamis','Jumat','Sabtu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hari): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($hari); ?>"><?php echo e($hari); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-slate-200 mb-1">Kelas</label>
                        <select name="kelas" id="edit_kelas" required class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 text-sm focus:border-uin-green dark:bg-slate-700 dark:text-white outline-none">
                            <option value="">-- Pilih Kelas --</option>
                            <?php $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($k->nama_kelas); ?>"><?php echo e($k->nama_kelas); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ghifa's court\web-presensi-feb\resources\views/admin/jadwal/index.blade.php ENDPATH**/ ?>