    ...
    <div class="bg-white glass rounded-xl p-6 shadow-sm border border-gray-100 dark:border-white/5">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-slate-400"><?php echo e($jadwal->mataKuliah->nama_mk); ?> - <?php echo e($jadwal->kelas); ?></p>
            </div>
        ...
        <div class="text-center mb-6 pb-4 border-b border-gray-200 dark:border-white/10">
            ...
            <p class="text-sm text-gray-500 dark:text-slate-400"><?php echo e($jadwal->mataKuliah->nama_mk); ?> (<?php echo e($jadwal->mataKuliah->sks); ?> SKS)</p>
            <p class="text-sm text-gray-500 dark:text-slate-400">Dosen: <?php echo e($jadwal->dosen->nama); ?></p>
            <p class="text-sm text-gray-500 dark:text-slate-400">Kelas: <?php echo e($jadwal->kelas); ?> &middot; Semester: <?php echo e($jadwal->semester_aktif); ?></p>
        </div>
        ...
        <div class="mt-12 flex justify-end">
            <div class="text-center">
                <p class="text-sm text-gray-600 dark:text-slate-300">Tangerang Selatan, <?php echo e(now()->translatedFormat('d F Y')); ?></p>
                <p class="text-sm text-gray-600 dark:text-slate-300 mt-1">Dosen Pengampu,</p>
                <div class="h-16"></div>
                <p class="text-sm font-semibold text-gray-800 dark:text-white"><?php echo e($jadwal->dosen->nama); ?></p>
