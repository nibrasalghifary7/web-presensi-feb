...
<?php $__env->startSection('title', __('app.admin.laporan_title')); ?>
<?php $__env->startSection('page-title', __('app.admin.laporan_title')); ?>
...
<div class="space-y-6">
        ...
        <form method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <select name="nidn" class="px-4 py-2 rounded-lg border border-gray-200 text-sm">
                ...
                <?php $__currentLoopData = $dosens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($d->nidn); ?>" <?php echo e(request('nidn') == $d->nidn ? 'selected' : ''); ?>><?php echo e($d->nama); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <input type="date" name="tanggal_mulai" value="<?php echo e(request('tanggal_mulai')); ?>" placeholder="Tanggal Mulai"
                   class="px-4 py-2 rounded-lg border border-gray-200 text-sm focus:border-uin-green outline-none">
            <input type="date" name="tanggal_akhir" value="<?php echo e(request('tanggal_akhir')); ?>" placeholder="Tanggal Akhir"
                   class="px-4 py-2 rounded-lg border border-gray-200 text-sm focus:border-uin-green outline-none">
            <div class="flex gap-2">
                <button type="submit" class="flex-1 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm hover:bg-gray-200">
                    <i class="fas fa-filter mr-1"></i> Filter
                </button>
                <a href="<?php echo e(route('admin.laporan.index')); ?>" class="px-4 py-2 bg-gray-50 text-gray-500 rounded-lg text-sm hover:bg-gray-100">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-4">
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center">
            <p class="text-2xl font-bold text-gray-800"><?php echo e($totalSemua); ?></p>
        ...
        <div class="bg-amber-50 rounded-xl p-4 shadow-sm border border-amber-200 text-center">
            <p class="text-2xl font-bold text-amber-600"><?php echo e($totalIzin); ?></p>
        ...
        <div class="bg-yellow-50 rounded-xl p-4 shadow-sm border border-yellow-200 text-center">
            <p class="text-2xl font-bold text-yellow-600"><?php echo e($totalSakit); ?></p>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php $__empty_1 = true; $__currentLoopData = $absensis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-5 py-3 text-sm text-gray-500"><?php echo e($absensis->firstItem() + $index); ?></td>
                            <td class="px-5 py-3 text-sm font-medium text-gray-800"><?php echo e($a->nim); ?></td>
                            <td class="px-5 py-3 text-sm text-gray-800"><?php echo e($a->mahasiswa->nama ?? '-'); ?></td>
                            <td class="px-5 py-3 text-sm text-gray-600"><?php echo e($a->jadwal->mataKuliah->nama_mk ?? '-'); ?></td>
                            <td class="px-5 py-3 text-sm text-gray-600"><?php echo e($a->jadwal->kelas ?? '-'); ?></td>
                            <td class="px-5 py-3 text-sm text-gray-600"><?php echo e($a->jadwal->dosen->nama ?? '-'); ?></td>
                            <td class="px-5 py-3 text-sm text-gray-600"><?php echo e($a->tanggal->translatedFormat('d M Y')); ?></td>
                            <td class="px-5 py-3">
        ...
        <div class="px-5 py-3 border-t border-gray-100"><?php echo e($absensis->withQueryString()->links()); ?></div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ghifa's court\web-presensi-feb\resources\views\admin\laporan\index.blade.php ENDPATH**/ ?>