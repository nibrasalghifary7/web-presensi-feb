...
<nav class="navbar">
  ...
  <div class="navbar-links">
    ...
    <a href="{{ route('login') }}" class="btn-nav"><i class="fas fa-right-to-bracket"></i> Masuk</a>
  </div>
  ...
  <div class="hero-inner">
    <div class="hero-left">
      ...
      <div class="hero-buttons">
        ...
        <a href="{{ route('register-mahasiswa') }}" class="btn-hero btn-hero-outline">
...
<!-- Footer -->
<footer class="footer">
  <p>&copy; {{ date('Y') }} <a href="#">M-PRESENCE FEB</a> — Fakultas Ekonomi dan Bisnis, UIN Syarif Hidayatullah Jakarta. All rights reserved.</p>
</footer>
