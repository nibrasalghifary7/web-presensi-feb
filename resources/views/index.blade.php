...
<body>
    ...
    <!-- Background layers -->
    <div class="bg-layer">
        <img class="bg-img" alt="" src="{{ asset('mansy-graphics-V1NQ60y4UK0-unsplash.jpg') }}">
    </div>
    ...
    <nav class="nav" id="navbar">
        ...
        <div class="nav-cta">
            <a href="{{ route('login') }}" class="btn-login"><i class="fas fa-right-to-bracket"></i> Masuk</a>
        </div>
        ...
        <div class="hero-wrap">
            <div class="hero-text">
                ...
                <div class="hero-actions">
                    <a href="{{ route('login') }}" class="btn-primary"><i class="fas fa-right-to-bracket"></i> Masuk
                        Aplikasi</a>
                    <a href="{{ route('register-mahasiswa') }}" class="btn-ghost"><i class="fas fa-user-plus"></i> Buat
                        Akun</a>
                </div>
            </div>
            ...
            <div class="hero-visual">
                ...
                <div class="deko-wrapper">
                    ...
                    <img class="deko-image" alt="M-Presence" src="{{ asset('images/hero.png') }}">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="cta">
        <div class="cta-box">
            ...
            <div class="cta-actions">
                <a href="{{ route('register-mahasiswa') }}" class="btn-primary"><i class="fas fa-user-plus"></i>
                    Daftar Sekarang</a>
                <a href="{{ route('login') }}" class="btn-ghost"><i class="fas fa-right-to-bracket"></i> Sudah Punya
                    Akun?</a>
            </div>
        </div>
    </section>
    ...
    <footer class="footer">
        <div class="footer-inner">
            ...
            <div class="footer-right">
                &copy; {{ date('Y') }} Fakultas Ekonomi dan Bisnis — UIN Syarif Hidayatullah Jakarta
            </div>
        </div>
    </footer>
