...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($mataKuliahs as $mk)
                        <tr class="hover:bg-gray-50">
                            <td class="px-5 py-3 text-sm font-medium text-gray-800">{{ $mk->kode_mk }}</td>
                            <td class="px-5 py-3 text-sm text-gray-800">{{ $mk->nama_mk }}</td>
                            <td class="px-5 py-3 text-sm text-center text-gray-600">{{ $mk->sks }}</td>
                            <td class="px-5 py-3 text-sm text-gray-600">{{ $mk->semester }}</td>
                            <td class="px-5 py-3">
        ...
        <div class="px-5 py-3 border-t border-gray-100">{{ $mataKuliahs->links() }}</div>
    </div>
