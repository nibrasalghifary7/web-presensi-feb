...
<div class="card-wrapper">
  ...
  <div class="register-panel">
    ...
    <div class="role-selector" id="roleSelector">
      ...
      <label for="roleMhs" id="labelMhs" onclick="slideTo('left', '{{ route('register-mahasiswa') }}')">MAHASISWA BARU</label>
    ...
    <form method="POST" action="{{ route('register-dosen.post') }}" style="display:flex;flex-direction:column;flex:1;">
      @csrf
      ...
      <div class="input-group">
        <input type="text" name="nidn" class="form-input" placeholder="Contoh: 19920808" value="{{ old('nidn') }}" required>
      </div>
