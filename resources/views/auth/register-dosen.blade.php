...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Montserrat:wght@500;700;800;900&family=Poppins:ital,wght@0,600;0,800;1,600&display=swap"
        rel="stylesheet">
    ...
    <div class="card-wrapper">
        ...
        <div class="branding-area">
            <div class="branding-content">
                <img class="deco-image" alt=""
                    src="{{ asset('005d5b9dc825d74b4f47a1a022a7913f-removebg-preview-1@2x.png') }}">
        ...
        <div class="register-panel">
            ...
            <div class="role-selector" id="roleSelector">
                ...
                <label for="roleMhs" id="labelMhs"
                    onclick="slideTo('left', '{{ route('register-mahasiswa') }}')">MAHASISWA BARU</label>
            ...
            <form method="POST" action="{{ route('register-dosen.post') }}"
                ...
                <div class="form-row">
                    <div class="form-col">
                        ...
                        <div class="input-group">
                            <input type="text" name="nidn" class="form-input" placeholder="Contoh: 19920808"
                ...
                <div class="input-group">
                    <input type="email" name="email" class="form-input" placeholder="Email Akademik..."
                    ...
                    <div class="form-col">
                        ...
                        <div class="input-group" style="margin-bottom:0;">
                            <div class="password-wrapper">
                                <input type="password" name="pin" id="pin" class="form-input"
                                    placeholder="123456" maxlength="6" inputmode="numeric" pattern="[0-9]*"
                                    value="{{ old('pin') }}"
                                    onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                <button type="button" class="password-toggle"
                                    onclick="togglePassword('pin','eyePin')">
                ...
                <div class="input-group">
                    <div class="password-wrapper">
                        <input type="password" name="password" id="password" class="form-input"
                            placeholder="Isi Sandi Akun..." required>
                ...
                <div class="input-group">
                    <div class="password-wrapper">
                        <input type="password" name="password_confirmation" id="password_confirmation"
                            class="form-input" placeholder="Ulangi Sandi..." required>
                        <button type="button" class="password-toggle"
