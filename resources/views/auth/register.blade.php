{{--
    Halaman Registrasi - M-Presence FEB
    Form khusus mahasiswa untuk mendaftarkan akun baru.
    Input: NIM, Nama Lengkap, Email, No.HP, Password.
    Desain: Card center-aligned dengan aksen hijau UIN.
--}}
<!DOCTYPE html>
...
<body class="h-full animated-gradient pattern-overlay flex items-center justify-center p-4 py-8">
    ...
    {{-- ========================================
         CARD REGISTRASI
         Form pendaftaran akun mahasiswa baru
         ======================================== --}}
            ...
            <form method="POST" action="{{ route('register.post') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <select id="kelas" name="kelas"
                        ...
                        <option value="Akuntansi A" {{ old('kelas') == 'Akuntansi A' ? 'selected' : '' }}>Akuntansi A</option>
                        <option value="Akuntansi B" {{ old('kelas') == 'Akuntansi B' ? 'selected' : '' }}>Akuntansi B</option>
                    </select>
                </div>
